...
public class ChocolateFeast {
    public static void chocFeast(String[] args) {
...
for every M wrappers he gives to the store, he gets one chocolate for free. How many chocolates does Bob get to eat?
