...
public class RansomNote {
    ...
    public static void ransomNote(String[] args) {

        int m = 15;

        int n = 17;

        String[] magazine = {"o", "l", "x", "imjaw", "bee", "khmla", "v", "o", "v", "o",
                "imjaw", "l", "khmla", "imjaw", "x"};

        String[] note = {"imjaw", "l", "khmla", "x", "imjaw", "o", "l", "l", "o",
                "khmla", "v", "bee", "o", "o", "imjaw", "imjaw", "o"};
